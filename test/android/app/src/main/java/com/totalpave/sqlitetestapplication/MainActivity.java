...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Log.e("UnexpectedError", "Could not open db", ex);
            return;
        }
        long statement;
        try {
            ...
            Log.e("UnexpectedError", "Could not prepare statement", ex);
            return;
        }
        ...
        try {
            ...
            Log.e("UnexpectedError", "Could not successfully run queries", ex);
        }
        finally {
            Sqlite.finalize(statement);
            Sqlite.close(db);
